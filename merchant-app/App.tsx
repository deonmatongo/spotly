    ...
    <View style={styles.splashFill}>
      <View style={styles.splashCenter}>
        ...
        <Animated.View style={wordStyle}>
          <AppText variant="display" style={styles.logoText} allowFontScaling={false}>spotly merchant</AppText>
        </Animated.View>
        <AppText variant="label" style={styles.logoTagline} allowFontScaling={false}>Your store · your way</AppText>
      </View>
    </View>
  )
}
...
const styles = StyleSheet.create({
  ...
  logoText: { color: colors.white, fontSize: 26, letterSpacing: -1 },
