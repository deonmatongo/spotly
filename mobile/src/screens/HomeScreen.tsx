    ...
    <View style={styles.safe}>
      ...
      <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 24 }}>
        ...
        <View style={styles.catGrid}>
          {CATEGORIES.map(cat => (
            <Pressable key={cat.id} style={styles.catItem} onPress={() => onCategory(cat)}>
        ...
        {/* ── Loyalty card (green) ── */}
        <Pressable onPress={() => (nav as any).navigate('Profile')}>
          <LinearGradient
          ...
          >
            ...
            <Text style={styles.loyaltyPoints}>{currentUser.points.toLocaleString()} <Text style={styles.loyaltyPointsUnit}>pts</Text></Text>
...
const makeStyles = (colors: Palette) => StyleSheet.create({
  ...
  greeting: { fontSize: 15, color: 'rgba(255,255,255,0.85)', fontWeight: '500', marginBottom: 2 },
  headline: { fontSize: 26, fontWeight: '800', color: colors.white, letterSpacing: -0.5 },
  ...
  locationText: { fontSize: 13, fontWeight: '600', color: colors.white },
  ...
  catIcon: { width: 58, height: 58, borderRadius: 18, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  catLabel: { fontSize: 12, fontWeight: '600', color: colors.textPrimary },

  // Loyalty card
  loyaltyCard: { marginHorizontal: spacing.md, borderRadius: radius.xl, padding: spacing.md, marginBottom: spacing.lg, ...shadow.md },
  ...
  loyaltyTier: { fontSize: 12, fontWeight: '700', color: colors.white },
  loyaltyPoints: { fontSize: 32, fontWeight: '900', color: colors.white, letterSpacing: -1, marginBottom: 12 },
  loyaltyPointsUnit: { fontSize: 16, fontWeight: '700', color: 'rgba(255,255,255,0.85)' },
  ...
  loyaltySub: { fontSize: 12, color: 'rgba(255,255,255,0.9)', fontWeight: '500' },
  ...
  // Promo
  promo: { flexDirection: 'row', alignItems: 'center', borderRadius: radius.xl, padding: spacing.md, overflow: 'hidden', ...shadow.md },
  promoTag: { fontSize: 10, fontWeight: '800', color: '#FCD34D', letterSpacing: 1, marginBottom: 6 },
  promoTitle: { fontSize: 18, fontWeight: '800', color: colors.white, lineHeight: 23, marginBottom: 12 },
  ...
  exploreTile: { width: '48%', height: 110, borderRadius: radius.lg, overflow: 'hidden', position: 'relative' },
  ...
  exploreLabel: { position: 'absolute', bottom: 10, left: 12, color: colors.white, fontSize: 14, fontWeight: '700' },

  // Trending
  trendRow: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: colors.surface, borderRadius: radius.lg, borderWidth: 1, borderColor: colors.border, padding: 10, marginBottom: 8, marginHorizontal: 0 },
  trendImage: { width: 54, height: 54, borderRadius: radius.md },
  trendInfo: { flex: 1 },
  trendName: { fontSize: 14, fontWeight: '700', color: colors.textPrimary },
  trendCuisine: { fontSize: 12, color: colors.textMuted, marginTop: 1, marginBottom: 4 },
  trendMeta: { flexDirection: 'row', alignItems: 'center' },
  trendMetaText: { fontSize: 12, color: colors.textMuted },
