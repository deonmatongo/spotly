...
export default function OrderTrackingScreen() {
  ...
  const etaMinutes = stage === 0 ? 28 : stage === 1 ? 22 : stage === 2 ? 10 : 0
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.mapBox}>
          ...
          <View style={styles.mapLabel}>
            ...
            <Text style={styles.mapLabelText}>Live tracking map</Text>
          </View>
        </View>
...
const makeStyles = (colors: Palette) => StyleSheet.create({
  ...
  mapBox: {
    height: 160, backgroundColor: '#E8F4E8', borderRadius: radius.lg,
  ...
  mapBlock: { width: '25%', height: 40, borderWidth: 0.5, borderColor: 'rgba(0,0,0,0.06)' },
  mapRoad1: { position: 'absolute', top: '40%', left: 0, right: 0, height: 12, backgroundColor: '#D1FAE5', opacity: 0.8 },
  mapRoad2: { position: 'absolute', top: 0, bottom: 0, left: '55%', width: 12, backgroundColor: '#D1FAE5', opacity: 0.8 },
  mapDestPin: {
  ...
  mapLabel: {
    ...
    backgroundColor: 'rgba(255,255,255,0.85)', borderRadius: 10, paddingHorizontal: 8, paddingVertical: 4,
  },
  mapLabelText: { fontSize: 11, color: colors.textMuted, fontWeight: '500' },
