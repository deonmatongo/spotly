...
const styles = StyleSheet.create({
  ...
  logoText: { fontSize: 52, fontWeight: '800', color: colors.white, letterSpacing: -2 },
  logoTagline: { fontSize: 14, color: colors.primaryLight, fontWeight: '500', marginTop: 8, letterSpacing: 0.3 },
  dots: { flexDirection: 'row', gap: 6, marginTop: 32 },
  dot: { width: 8, height: 8, borderRadius: 4, backgroundColor: colors.primaryLight },
  splashFooter: { position: 'absolute', bottom: 48, alignSelf: 'center', color: '#64748B', fontSize: 11, letterSpacing: 3, textTransform: 'uppercase' },
})
