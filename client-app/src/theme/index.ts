...
// Two-voice type system shared with the driver app: Space Grotesk carries
// numbers & headlines, Manrope carries everything read at length. Loaded in
// App.tsx via useFonts — these string keys must match the export names exactly.
export const fonts = {
...
// Asymmetric corner presets shared with the driver app — pairing a sharp
// corner with a generous one gives shapes a cut, folded-paper feel instead of
// a uniform rounded-rect grid.
export const cut = {
