          ...
          return (
            ...
            >
              <View style={styles.iconStack}>
                ...
                />
                {isCart && totalItems > 0 && (
                  <View style={[styles.badge, { backgroundColor: colors.amber, borderColor: colors.surface }]}>
                    <Animated.Text style={styles.badgeText}>{totalItems}</Animated.Text>
                  </View>
                )}
              </View>
              <Animated.Text style={[styles.label, { color: focused ? colors.primary : colors.textLight }]}>
...
const makeStyles = (colors: any) => StyleSheet.create({
  ...
  badge: {
    position: 'absolute', top: 0, right: 4, minWidth: 16, height: 16, borderRadius: 8, borderWidth: 1.5,
    alignItems: 'center', justifyContent: 'center', paddingHorizontal: 3,
  },
  badgeText: { fontFamily: fonts.bodyBold, fontSize: 9, color: '#0D1B2A' },
  label: { fontFamily: fonts.bodyBold, fontSize: 9, letterSpacing: 1.1, marginTop: 6 },
})
